...
(antes tambien debemos de entrar a la carpeta tanto del protecto como de las carpetas OPTICFLOW)

    cd OPTICFLOW1

  Carpeta optifiber(terminal dentro del proyecto) nos permitira entrar a la carpeta de OPTICFLOW
